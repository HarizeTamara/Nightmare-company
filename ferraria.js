const localStorageKey = 'to-do-list-ferraria';
import { recipesFerraria } from './RecipesFerraria.js';
import { ingredientCosts } from './IngredientCostsFerraria.js'; // novo
...
function populateRecipeSelect() {
    ...
    Object.keys(recipesFerraria).forEach(recipeName => {
